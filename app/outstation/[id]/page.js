      ...
      <div className="relative z-10 max-w-4xl px-4 mx-auto ">
        ...
        <div className="p-6 mb-6 bg-white rounded-2xl">
          ...
          <div className="p-4 mt-4 bg-orange-100 border-2 border-orange-200 rounded-xl">
            <h4 className="mb-1 text-sm font-bold text-orange-800">
              Estimated 1-Day Cost
            </h4>
            <p className="mb-2 text-sm text-orange-700">
              ({vehicle.minKm} km x &#8377;{vehicle.farePerKm}) + &#8377;
              {vehicle.driverBata} driver bata
            </p>
            <p className="text-2xl font-bold text-orange-600">
              &#8377;{estimatedDayCost.toLocaleString("en-IN")}
            </p>
            <p className="mt-1 text-sm text-orange-600">
              * Toll, parking & interstate taxes extra
            </p>
          </div>
        </div>
        ...
        <div className="hidden p-6 mb-6 bg-white rounded-2xl">
          ...
          <ul className="space-y-3">
            {[
              // 1. Minimum KM & Calendar Day
              `Minimum 300 km per day. A calendar day is considered from 12:00 AM to 11:59 PM. (Example: 2 days = 600 km cumulative).`,

              // 2. KM Billing
              `Distance is generally charged garage-to-garage, though point-to-point billing applies in specific cases.`,

              // 3. Driver Charges
              `Daily Driver Bata applies (6am–10pm). Additional night allowance applies if used before 6am or after 10pm.`,

              // 4. Parking & Tolls
              `Parking fees and highway tolls are not included in the base fare and will be charged at actuals as required.`,

              // 5. Interstate Taxes
              `Interstate taxes for Tamil Nadu, Kerala, Pondicherry, etc., are charged as per state rules despite All India Permits.`,

              // 6. One Way Drop
              `One-way trips are billed for round-trip distance (garage-to-garage), though special discounts may apply.`,
            ].map((item, i) => (
              <li
                key={i}
                className="flex items-start gap-3 p-3 rounded-xl "
              >
                <div className="flex items-center justify-center flex-shrink-0 w-6 h-6 text-sm font-bold text-white bg-orange-500 rounded-lg shadow-sm">
                  {i + 1}
                </div>
          ...
          <div className="p-3 mt-4 border border-yellow-200 bg-yellow-50 rounded-xl">
            <p className="text-sm text-yellow-800">
              <strong>Note:</strong> This is an informational website providing
              pricing details that may vary based on seasons, weekends, holidays
              including New Year, Deepavali and government holidays. Please
              confirm rates before proceeding. E&OE.
            </p>
          </div>
        </div>
        ...
        <div className="p-6 mb-6 bg-white rounded-2xl">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <div className="p-4 text-center bg-blue-50 rounded-xl">
              <p className="text-sm font-bold text-blue-800">1 Day Booking</p>
              <p className="mt-1 text-sm text-blue-600">
                Minimum 300 km charged
              </p>
              <p className="mt-1 text-lg font-bold text-blue-700">
                &#8377;
                {(vehicle.farePerKm * 300 + vehicle.driverBata).toLocaleString(
                  "en-IN",
                )}
              </p>
            </div>
            <div className="p-4 text-center bg-blue-50 rounded-xl">
              <p className="text-sm font-bold text-blue-800">2 Day Booking</p>
              <p className="mt-1 text-sm text-blue-600">
                Minimum 600 km charged
              </p>
              <p className="mt-1 text-lg font-bold text-blue-700">
                &#8377;
                {(
                  vehicle.farePerKm * 600 +
                  vehicle.driverBata * 2
