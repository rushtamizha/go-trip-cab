...
function HeroSlider() {
  ...
  return (
    <div className="relative mt-10 w-full h-[750px] md:h-[800px] overflow-hidden">
      {heroImages.map((img, i) => (
        ...
        >
          ...
          />
          <div className="absolute inset-0 hidden bg-gradient-to-t from-black/70 via-black/30 to-transparent" />
        </div>
      ))}
