...
export const Inclusion = ["Pickup & drop from bangalore city","Cab for package days","Driver bata for package days","Fuel charges","State permits","complete sightseeing transportation"]

export const Exclusion = ["meals ( Breakfast / Lunch / Dinner ) ","Entry tickets ( if any ) ","Water Activites / Boating","Extra driver bata ( before 06:00AM pickup or after 10:00 PM usage","Extra usage beyond KM / package time","Toll & Parking charges"]
