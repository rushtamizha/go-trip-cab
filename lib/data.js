...
export const localIncludes = ["Driver Bata ( Allowance )"]

export const localExcludes = ["Toll Charges & Parking"]
...
export const outstationTaxis = [
  ...
  { id: 'out-tempo-ac', name: 'Tempo Traveller Outstation (A/C)', models: 'Tempo Traveller (AC)', seats: 12, farePerKm: 23, driverBata: 700, nightBata: 350, minKm: 300, image: carImages.tempo },
   ...
   { id: 'out-tempo-ac', name: 'Luxury Tempo Traveller', models: 'Tempo Traveller (AC)', seats: 10, farePerKm: 26, driverBata: 600, nightBata: 600, minKm: 300, image: carImages.tempo },

   { id: 'out-tempo-ac', name: 'Maharaja Tempo Traveller', models: 'Tempo Traveller (AC)', seats: 14, farePerKm: 33, driverBata: 600, nightBata: 600, minKm: 300, image: carImages.tempo },

   { id: 'out-tempo-ac', name: '21 seater Minibus Rental', models: 'Tempo Traveller (AC)', seats: 14, farePerKm: 29, driverBata: 700, nightBata: 700, minKm: 300, image: carImages.tempo },

   { id: 'out-tempo-ac', name: '25 seater MiniBus Rental', models: 'Tempo Traveller (AC)', seats: 14, farePerKm: 29, driverBata: 700, nightBata: 700, minKm: 300, image: carImages.tempo },

   { id: 'out-tempo-ac', name: '33 Seater Bus', models: 'Tempo Traveller (AC)', seats: 14, farePerKm: 29, driverBata: 700, nightBata: 700, minKm: 300, image: carImages.tempo },

   { id: 'out-tempo-ac', name: '50 Seater Bus', models: 'Tempo Traveller (AC)', seats: 14, farePerKm: 29, driverBata: 700, nightBata: 700, minKm: 300, image: carImages.tempo },
];
