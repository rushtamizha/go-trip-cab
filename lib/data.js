...
export const TermsConditions = [ "All state taxes/permits are valid for one week and a single entry only. These charges can be paid online or at the respective check post.",
"The quoted price is subject to change based on factors such as seasonal demand, increase in fuel prices, and peak days/weekends (e.g., Saturday, Sunday, New Year, Deepavali, etc.).",
"Customers are requested to confirm the final rates before proceeding with the booking.","Maintain cleanliness and proper vehicle care.",
...
"All disputes are subject to Bangalore jurisdiction.","During peak seasons / high-demand periods, confirmed bookings cannot be changed or cancelled.",
"This includes weekends, festivals, and peak travel dates.",
"Customers are advised to confirm cancellation terms at the time of booking.",
"In case of delays, our 24/7 support team will assist in arranging an alternate vehicle, wherever possible.",
",If the booked vehicle fails to arrive, a full refund of the advance amount will be processed.","Pets are not allowed inside car"]